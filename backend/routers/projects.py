...
from backend.models.project import Sprint, Task, Subtask, TaskComment, TaskAuditLog
...
def update_project_settings(
    ...
    ensure_project_member(project_id, current_user.id, db)
    check_project_permission(db, current_user.id, project_id, PROJECT_SETTINGS_ROLES)
...
def update_role_permissions(
    ...
    check_project_permission(db, current_user.id, project_id, ROLE_MANAGEMENT_ROLES)
...
def get_project_invitations(
    ...
    check_project_permission(db, current_user.id, project_id, TEAM_MANAGEMENT_ROLES)
